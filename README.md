...
```bash
# Запуск виртуальной торговой системы с интегрированным Telegram ботом
npm run run
...
- **Telegram Bot**: Интегрирован в основную систему торговли
...
Telegram бот полностью интегрирован в основную систему торговли:

- **Единый экземпляр**: Используется синглтон для предотвращения конфликтов
- **Команды бота**: `/start`, `/trades`, `/watchlist`, `/stats`, `/trading`, `/status`, `/help`
- **Автоматические уведомления**: О событиях системы, сделках, уровнях прибыли
- **Приветственное сообщение**: Отправляется при запуске системы

**Тестирование интеграции:**
```bash
npm run test:telegram-integration    # Тест интеграции Telegram бота
```
